...
})], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center gap-3"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-1 min-w-0"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"font-medium text-gray-800"], null),new cljs.core.Keyword(null,"descricao","descricao",861900814).cljs$core$IFn$_invoke$arity$1(template)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center gap-2 mt-1"], null),(function (){var iter__5628__auto__ = (function casa_financas$views$templates$item_template_$_iter__12637(s__12638){
return (new cljs.core.LazySeq(null,(function (){
var s__12638__$1 = s__12638;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__12638__$1);
if(temp__5823__auto__){
var s__12638__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12638__$2)){
var c__5626__auto__ = cljs.core.chunk_first(s__12638__$2);
var size__5627__auto__ = cljs.core.count(c__5626__auto__);
var b__12640 = cljs.core.chunk_buffer(size__5627__auto__);
if((function (){var i__12639 = (0);
while(true){
if((i__12639 < size__5627__auto__)){
var pid = cljs.core._nth(c__5626__auto__,i__12639);
cljs.core.chunk_append(b__12640,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [casa_financas.components.comum.chip_pessoa,pid], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),pid], null)));

var G__12692 = (i__12639 + (1));
i__12639 = G__12692;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12640),casa_financas$views$templates$item_template_$_iter__12637(cljs.core.chunk_rest(s__12638__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12640),null);
}
} else {
var pid = cljs.core.first(s__12638__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [casa_financas.components.comum.chip_pessoa,pid], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),pid], null)),casa_financas$views$templates$item_template_$_iter__12637(cljs.core.rest(s__12638__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12669),casa_financas$views$templates$templates_$_iter__12666(cljs.core.chunk_rest(s__12667__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12669),null);
}
} else {
var t = cljs.core.first(s__12667__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [casa_financas.views.templates.item_template,t], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(t)], null)),casa_financas$views$templates$templates_$_iter__12666(cljs.core.rest(s__12667__$2)));
}
} else {
return null;
}
