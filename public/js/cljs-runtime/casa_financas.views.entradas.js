...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(acc,pid,(function (p1__26592_SHARP_){
return ((function (){var or__5142__auto__ = p1__26592_SHARP_;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26606),casa_financas$views$entradas$entradas_$_iter__26603(cljs.core.chunk_rest(s__26604__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26606),null);
}
} else {
var e = cljs.core.first(s__26604__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [casa_financas.views.entradas.item_entrada,e], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(e)], null)),casa_financas$views$entradas$entradas_$_iter__26603(cljs.core.rest(s__26604__$2)));
}
} else {
return null;
}
