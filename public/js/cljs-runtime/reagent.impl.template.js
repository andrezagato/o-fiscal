...
var G__21999 = o;
reagent.impl.template.goog$module$goog$object.set(G__21999,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22029__delegate = function (args){
...
while (G__22030__i < G__22030__a.length) {G__22030__a[G__22030__i] = arguments[G__22030__i + 0]; ++G__22030__i;}
  args = new cljs.core.IndexedSeq(G__22030__a,0,null);
} 
return G__22029__delegate.call(this,args);};
...
return G__22029__delegate(args);
});
...
var G__22000 = o;
reagent.impl.template.goog$module$goog$object.set(G__22000,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__22033__i < G__22033__a.length) {G__22033__a[G__22033__i] = arguments[G__22033__i + 0]; ++G__22033__i;}
  args = new cljs.core.IndexedSeq(G__22033__a,0,null);
} 
return G__22032__delegate.call(this,args);};
G__22032.cljs$lang$maxFixedArity = 0;
G__22032.cljs$lang$applyTo = (function (arglist__22034){
var args = cljs.core.seq(arglist__22034);
...
var G__22001 = props;
var G__22001__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22001,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22001);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22001__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22002 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22002,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22002;
}
})(),id_class);
...
var G__22003 = (cljs.core.count(argv) - first_child);
switch (G__22003) {
case (0):
...
var vec__22004 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22004,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22004,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22004,(2),null);
...
var temp__5827__auto___22043 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___22043 == null)){
} else {
var key_22044 = temp__5827__auto___22043;
(jsprops.key = key_22044);
}
...
var temp__5827__auto___22047 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___22047 == null)){
} else {
var key_22051 = temp__5827__auto___22047;
(jsprops.key = key_22051);
}
...
var temp__5827__auto___22052 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___22052 == null)){
} else {
var key_22053 = temp__5827__auto___22052;
(jsprops.key = key_22053);
}
...
var temp__5827__auto___22069 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___22069 == null)){
} else {
var key_22070 = temp__5827__auto___22069;
(jsprops.key = key_22070);
}
...
var temp__5827__auto___22078 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___22078 == null)){
} else {
var key_22079 = temp__5827__auto___22078;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22013_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22013_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22014 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22014,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22014,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template22020 = (function (opts,id,fn_to_element,parse_fn,meta22021){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta22021 = meta22021;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template22020.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22022,meta22021__$1){
var self__ = this;
var _22022__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22020(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22021__$1));
}));

(reagent.impl.template.t_reagent$impl$template22020.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22022){
var self__ = this;
var _22022__$1 = this;
return self__.meta22021;
}));

(reagent.impl.template.t_reagent$impl$template22020.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22020.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22020.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22020.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22020.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22020.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22021","meta22021",-992143036,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22020.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22020.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22020");

(reagent.impl.template.t_reagent$impl$template22020.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/t_reagent$impl$template22020");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22020.
 */
reagent.impl.template.__GT_t_reagent$impl$template22020 = (function reagent$impl$template$__GT_t_reagent$impl$template22020(opts,id,fn_to_element,parse_fn,meta22021){
return (new reagent.impl.template.t_reagent$impl$template22020(opts,id,fn_to_element,parse_fn,meta22021));
});
...
return (new reagent.impl.template.t_reagent$impl$template22020(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
