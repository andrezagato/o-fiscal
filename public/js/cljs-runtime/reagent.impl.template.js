...
var G__17480 = o;
reagent.impl.template.goog$module$goog$object.set(G__17480,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__17864__i < G__17864__a.length) {G__17864__a[G__17864__i] = arguments[G__17864__i + 0]; ++G__17864__i;}
  args = new cljs.core.IndexedSeq(G__17864__a,0,null);
} 
...
var G__17557 = o;
reagent.impl.template.goog$module$goog$object.set(G__17557,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__17584 = props;
var G__17584__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17584,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17584);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17584__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__17594 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17594,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__17594;
}
})(),id_class);
...
var G__17608 = (cljs.core.count(argv) - first_child);
switch (G__17608) {
case (0):
...
var vec__17626 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17626,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17626,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17626,(2),null);
...
var temp__5827__auto___17901 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___17901 == null)){
} else {
var key_17902 = temp__5827__auto___17901;
(jsprops.key = key_17902);
}
...
var temp__5827__auto___17907 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___17907 == null)){
} else {
var key_17908 = temp__5827__auto___17907;
(jsprops.key = key_17908);
}
...
var temp__5827__auto___17924 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___17924 == null)){
} else {
var key_17925 = temp__5827__auto___17924;
(jsprops.key = key_17925);
}
...
var temp__5827__auto___17942 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___17942 == null)){
} else {
var key_17944 = temp__5827__auto___17942;
(jsprops.key = key_17944);
}
...
var temp__5827__auto___17950 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___17950 == null)){
} else {
var key_17952 = temp__5827__auto___17950;
(jsprops.key = key_17952);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17693_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__17693_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__17698 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17698,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17698,(1),null);
...
break;
default:
var G__17970 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__17971 = compiler;
v = G__17970;
compiler = G__17971;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template17741 = (function (opts,id,fn_to_element,parse_fn,meta17742){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template17741.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17743,meta17742__$1){
var self__ = this;
var _17743__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template17741(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta17742__$1));
}));

(reagent.impl.template.t_reagent$impl$template17741.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17743){
var self__ = this;
var _17743__$1 = this;
return self__.meta17742;
}));

(reagent.impl.template.t_reagent$impl$template17741.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template17741.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template17741.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template17741.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template17741.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template17741.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta17742","meta17742",-907946156,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template17741.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template17741.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template17741");

(reagent.impl.template.t_reagent$impl$template17741.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/t_reagent$impl$template17741");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template17741.
 */
reagent.impl.template.__GT_t_reagent$impl$template17741 = (function reagent$impl$template$__GT_t_reagent$impl$template17741(opts,id,fn_to_element,parse_fn,meta17742){
return (new reagent.impl.template.t_reagent$impl$template17741(opts,id,fn_to_element,parse_fn,meta17742));
});
...
return (new reagent.impl.template.t_reagent$impl$template17741(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
