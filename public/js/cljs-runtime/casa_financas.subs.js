...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"despesas-do-mes","despesas-do-mes",2018938320),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"despesas","despesas",786163068)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mes-atual","mes-atual",1459588153)], null),(function (p__25848,_){
var vec__25849 = p__25848;
var despesas = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25849,(0),null);
var mes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25849,(1),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"entradas-do-mes","entradas-do-mes",956329241),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"entradas","entradas",-1856269220)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mes-atual","mes-atual",1459588153)], null),(function (p__25853,_){
var vec__25854 = p__25853;
var entradas = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25854,(0),null);
var mes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25854,(1),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"saldo-acumulado-anterior","saldo-acumulado-anterior",1945889983),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"despesas-historico","despesas-historico",-1529211160)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"entradas-historico","entradas-historico",-736138754)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mes-atual","mes-atual",1459588153)], null),(function (p__25862,_){
var vec__25863 = p__25862;
var despesas = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25863,(0),null);
var entradas = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25863,(1),null);
var mes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25863,(2),null);
var desp_ant = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__25860_SHARP_){
return casa_financas.subs.mes_estritamente_anterior_QMARK_(new cljs.core.Keyword(null,"ano","ano",109602792).cljs$core$IFn$_invoke$arity$1(p1__25860_SHARP_),new cljs.core.Keyword(null,"mes","mes",-890288111).cljs$core$IFn$_invoke$arity$1(p1__25860_SHARP_),new cljs.core.Keyword(null,"ano","ano",109602792).cljs$core$IFn$_invoke$arity$1(mes),new cljs.core.Keyword(null,"mes","mes",-890288111).cljs$core$IFn$_invoke$arity$1(mes));
}),despesas);
...
var total_desp = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"valor","valor",-957162173),desp_ant));
return (total_entr - total_desp);
})], 0));
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"saldo-acumulado-anterior-pessoa","saldo-acumulado-anterior-pessoa",930608122),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__25868){
var vec__25869 = p__25868;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25869,(0),null);
var pessoa_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25869,(1),null);
var mes = new cljs.core.Keyword(null,"mes-atual","mes-atual",1459588153).cljs$core$IFn$_invoke$arity$1(db);
var despesas = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__25866_SHARP_){
return casa_financas.subs.mes_estritamente_anterior_QMARK_(new cljs.core.Keyword(null,"ano","ano",109602792).cljs$core$IFn$_invoke$arity$1(p1__25866_SHARP_),new cljs.core.Keyword(null,"mes","mes",-890288111).cljs$core$IFn$_invoke$arity$1(p1__25866_SHARP_),new cljs.core.Keyword(null,"ano","ano",109602792).cljs$core$IFn$_invoke$arity$1(mes),new cljs.core.Keyword(null,"mes","mes",-890288111).cljs$core$IFn$_invoke$arity$1(mes));
...
var total_entr = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"valor","valor",-957162173),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__25867_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pessoa_id","pessoa_id",-1264984672).cljs$core$IFn$_invoke$arity$1(p1__25867_SHARP_),pessoa_id);
}),entradas)));
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"cor-pessoa","cor-pessoa",-1425578316),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"configuracoes","configuracoes",800955038)], null),(function (configs,p__25874){
var vec__25876 = p__25874;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25876,(0),null);
var pessoa_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25876,(1),null);
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(configs,(""+"cor_"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(pessoa_id)),(function (){var G__25881 = pessoa_id;
switch (G__25881) {
case "andre":
return "#3B82F6";
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"valor","valor",-957162173),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__25886_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"forma_pagamento","forma_pagamento",205169437).cljs$core$IFn$_invoke$arity$1(p1__25886_SHARP_),"credito");
}),despesas)));
})], 0));
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"total-pago-mes","total-pago-mes",-1297613936),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"despesas-do-mes","despesas-do-mes",2018938320)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"fatura","fatura",18781370)], null),(function (p__25890,_){
var vec__25891 = p__25890;
var despesas = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25891,(0),null);
var fatura = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25891,(1),null);
var pago_pix = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"valor","valor",-957162173),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__25888_SHARP_){
var and__5140__auto__ = new cljs.core.Keyword(null,"pago","pago",27952415).cljs$core$IFn$_invoke$arity$1(p1__25888_SHARP_);
if(cljs.core.truth_(and__5140__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"forma_pagamento","forma_pagamento",205169437).cljs$core$IFn$_invoke$arity$1(p1__25888_SHARP_),"credito");
} else {
