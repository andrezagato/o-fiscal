...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__21987){
var map__21988 = p__21987;
var map__21988__$1 = cljs.core.__destructure_map(map__21988);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21988__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__5142__auto__ = (!((((node === document.activeElement)) && (((reagent.impl.input.has_selection_api_QMARK_(node.type)) && (((typeof rendered_value === 'string') && (typeof dom_value === 'string'))))))));
if(or__5142__auto__){
...
var _STAR_force_set_dom_value_STAR__orig_val__21989 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__21990 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__21990);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__21989);
}}));
} else {
...
(jsprops.onChange = (function (p1__21991_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__21991_SHARP_);
}));
